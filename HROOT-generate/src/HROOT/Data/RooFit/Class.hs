...
rooAbsReal :: Class
rooAbsReal =
  -- AbstractClass roofitcabal "RooAbsReal" [rooAbsArg] mempty
  roofitclass
    "RooAbsReal"
    [rooAbsArg]
...
rooAbsRealLValue =
  -- AbstractClass roofitcabal "RooAbsRealLValue" [rooAbsReal, rooAbsLValue] mempty
  roofitclass
    "RooAbsRealLValue"
    [rooAbsReal, rooAbsLValue]
...
rooDataHist =
  roofitclass
    "RooDataHist"
    [rooAbsData, rooDirItem]
    []

rooAbsPdf :: Class
rooAbsPdf =
  -- AbstractClass roofitcabal "RooAbsPdf" [rooAbsReal] mempty
  -- [ ]
  roofitclass
    "RooAbsPdf"
    [rooAbsReal]
...
rooFitResult =
  roofitclass
    "RooFitResult"
    [tNamed, rooPrintable, rooDirItem]
    []
