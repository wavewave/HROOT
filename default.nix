...

{
  ...
  "HROOT-graf" =
     pkgs.haskell.lib.overrideCabal (self.callCabal2nix "HROOT-graf" (HROOT-src + "/HROOT-graf") {}) {
       librarySystemDepends = [pkgs.root];
     };
  "HROOT-hist" =
     pkgs.haskell.lib.overrideCabal (self.callCabal2nix "HROOT-hist" (HROOT-src + "/HROOT-hist") {}) {
       librarySystemDepends = [pkgs.root];
     };
  "HROOT-io"   =
     pkgs.haskell.lib.overrideCabal (self.callCabal2nix "HROOT-io" (HROOT-src + "/HROOT-io") {}) {
       librarySystemDepends = [pkgs.root];
     };
  "HROOT-math" =
  ...
  "HROOT-RooFit" =
     pkgs.haskell.lib.overrideCabal (self.callCabal2nix "HROOT-RooFit" (HROOT-src + "/HROOT-RooFit") {}) {
       librarySystemDepends = [pkgs.root];
     };
  "HROOT-RooFit-RooStats" =
     pkgs.haskell.lib.overrideCabal (self.callCabal2nix "HROOT-RooFit-RooStats" (HROOT-src + "/HROOT-RooFit-RooStats") {}) {
       librarySystemDepends = [pkgs.root];
     };
}
